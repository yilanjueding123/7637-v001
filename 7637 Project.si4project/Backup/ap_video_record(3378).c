...
void ap_video_record_md_tick(INT16U * md_tick, INT32U state);
INT8S ap_video_record_md_active(INT16U * md_tick, INT32U state);
...
INT8S ap_video_record_md_active(INT16U * md_tick, INT32U state)
{
	*md_tick			= 0;
	...
	{
		DBG_PRINT("ap_video_record_md_active\n");
...
extern INT8U record_size_get(void);
