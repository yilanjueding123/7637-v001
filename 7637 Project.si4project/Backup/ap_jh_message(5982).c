...
const INT8U 	R_CopyrightMSG_Buf[] = "版权声明: 本产品由深圳市乐信兴业科技有限公司设计,版权所有,仿冒必究";
	 //
const INT8U 	sensor_type_name[9][13] =
{
	"OV7670", "OV9712", "SOI_H22", "BF3703", "SOI_H22_MIPI", "OV3640", "OV5642", 
	"GC1004", "GC1004_MIPI"
};


INT8U			init_buff[23] = "2017-03-27 23:59:59   ";
...
volatile INT8U	MODECTION_FLAG = 0;
...
Fail_Return_2:
	...
	nRet				= gp_strncmp((INT8S *) addr, (INT8S *) "2017-03-27 23:59:59 ", 19); //杩斿洖0琛ㄧず鍙傛暟1鍜屽弬鏁?鐨勫唴瀹瑰畬鍏ㄧ浉鍚?
