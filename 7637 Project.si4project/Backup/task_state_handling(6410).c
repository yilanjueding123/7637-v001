...
void state_handling_init(void)
{
...
#if GPDV_BOARD_VERSION				!= GPCV1237A_Aerial_Photo
	{
		...
		{
			216, 144, TRANSPARENT_COLOR, 0, 0
		};
		INT32U			i, *buff_ptr, color_data, cnt;
		INT32U			display_frame0;

		display_battery_low_frame0 = (INT32U)
		gp_malloc_align(icon.icon_w * icon.icon_h * 2, 64);
		DBG_PRINT("batteryLow_display_buf_addr = 0x%x \r\n", display_frame0);
		buff_ptr			= (INT32U *)
		display_battery_low_frame0;
